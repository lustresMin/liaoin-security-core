package com.liaoin.security.core.validate.service.impl;
...
import com.liaoin.security.core.validate.service.ValidateCodeProcessor;
...
public abstract class AbstractValidateCodeProcessor<C extends ValidateCode> implements ValidateCodeProcessor {
    ...
    /**
     * 收集spring容器中所有的 {@link ValidateCodeGenerator} 接口的实现。
     */
    @Autowired
	...
	private String getSessionKey(ServletWebRequest request) {
        return securityProperties.getCode().getSessionKeyPrefix() + getValidateCodeType(request).toString().toUpperCase();
    }
	...
	/**
	 * 方法重构，分为移动端和PC端获取不同的验证码，以及删除验证码
	 * @param request request
	 */
	@SuppressWarnings("unchecked")
    @Override
